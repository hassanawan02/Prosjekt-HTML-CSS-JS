...
<body>
	...
	<div class="info">
		...
		$sql = "SELECT * FROM reisetips WHERE attraksjon_id='3'";
		$resultat = $kobling->query($sql);
		
		
	
		echo "<h1 class='overskrift'>Reisetips for Tokyo Tårnet</h1>";
		echo "<table>";
		...
		echo "</table>";
		echo "<br>Kilder: <a class='kilde' href='https://no.tripadvisor.com/Attraction_Review-g14129730-d320047-Reviews-Tokyo_Tower-Shibakoen_Minato_Tokyo_Tokyo_Prefecture_Kanto.html'>https://no.tripadvisor.com/Attraction_Review-g14129730-d320047-Reviews-Tokyo_Tower-Shibakoen_Minato_Tokyo_Tokyo_Prefecture_Kanto.html</a>";
	?>
		<?php 
	...
	?>
		...
		echo "<h1 class='overskrift'> Slett reisetips for Tokyo Tårnet </h1>";
		echo "<table>";
		while($rad = $resultat->fetch_assoc()) {
