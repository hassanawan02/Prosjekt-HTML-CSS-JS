...
<body>
	...
	<div class="info">
		...
		$sql = "SELECT * FROM reisetips WHERE attraksjon_id='2'";
		$resultat = $kobling->query($sql);
		
		
	
		echo "<h1 class='overskrift'>Reisetips for Ueno Dyrepark</h1>";
		echo "<table>";
		...
		echo "</table>";
		echo "<br>Kilder: <a class='kilde' href='https://no.tripadvisor.com/Attraction_Review-g14134278-d320441-Reviews-Ueno_Park-Uenokoen_Taito_Tokyo_Tokyo_Prefecture_Kanto.html'>https://no.tripadvisor.com/Attraction_Review-g14134278-d320441-Reviews-Ueno_Park-Uenokoen_Taito_Tokyo_Tokyo_Prefecture_Kanto.html</a>";
	?>
		<?php 
	...
	?>
		...
		echo "<h1 class='overskrift'> Slett reisetips for Ueno Dyrepark </h1>";
		echo "<table>";
		while($rad = $resultat->fetch_assoc()) {
