...
<body>
	...
	<div class="info">
		...
		$sql = "SELECT * FROM reisetips WHERE attraksjon_id='4'";
		$resultat = $kobling->query($sql);
		
		
	
		echo "<h1 class='overskrift'>Reisetips for Yomiuri Land</h1>";
		echo "<table>";
		...
		echo "</table>";
		echo "<br>Kilder: <a class='kilde' href='https://no.tripadvisor.com/Attraction_Review-g298184-d1425364-Reviews-Yomiuri_Land-Tokyo_Tokyo_Prefecture_Kanto.html'>https://no.tripadvisor.com/Attraction_Review-g298184-d1425364-Reviews-Yomiuri_Land-Tokyo_Tokyo_Prefecture_Kanto.html</a>";
	?>
		<?php 
	...
	?>
		...
		echo "<h1 class='overskrift'> Slett reisetips for Yomiuri Land </h1>";
		echo "<table>";
		while($rad = $resultat->fetch_assoc()) {
