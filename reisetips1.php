...
<body>
	...
	<div class="info">
		...
		$sql = "SELECT * FROM reisetips WHERE attraksjon_id='1'";
		$resultat = $kobling->query($sql);
		
		
	
		echo "<h1 class='overskrift'>Reisetips for Sensoji Tempelet</h1>";
		echo "<table>";
		...
		echo "</table>";
		echo "<br>Kilder: <a class='kilde'https://no.tripadvisor.com/Attraction_Review-g14134311-d320447-Reviews-Senso_ji_Temple-Asakusa_Taito_Tokyo_Tokyo_Prefecture_Kanto.html'>https://no.tripadvisor.com/Attraction_Review-g14134311-d320447-Reviews-Senso_ji_Temple-Asakusa_Taito_Tokyo_Tokyo_Prefecture_Kanto.html</a>";
	?>
		<?php 
	...
	?>
		...
		echo "<h1 class='overskrift'> Slett reisetips for Sensoji Tempelet </h1>";
		echo "<table>";
		while($rad = $resultat->fetch_assoc()) {
