...
<body>
	...
	$tjener = "127.0.0.1";
		...
		$sql = "SELECT * FROM transportmiddel";
		...
		echo "<table>";
		echo "<tr><th>Transport type</th><th>Firma navn</th><th>Billett pris for dagen</th><th>Bilde</th></tr>";
		while($rad = $resultat->fetch_assoc()) {
			$transportmiddel_type = $rad["transportmiddel_type"];
			$firma_navn = $rad["firma_navn"];
			$billett_pris = $rad["billett_pris"];
			$bilde = $rad["bilde"];
			
			echo "<tr><td>$transportmiddel_type </td><td>$firma_navn</td> <td> $billett_pris kr</td><td><img src='bilder/$bilde'></td></tr>";
			
		}
		echo "</table>";
		echo "<br>Kilder: <a class='kilde' href='https://tobus.jp/blsys/navi?LCD=e'>https://tobus.jp/blsys/navi?LCD=e</a>";
		echo "<br><a class='kilde' href='https://www.tokyometro.jp/en/'>https://www.tokyometro.jp/en/</a>";
	?>
	</div>
	<div class="bunntekst">
